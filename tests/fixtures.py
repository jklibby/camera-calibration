...
config_dict: CalibratorConfig = {
    ...
    'camera_capture': {
        ...
        'right_cam_id': 1, 
        'image_count': 50, 
        'image_path': '../calibration-images/calibration-images/single_images/', # need to change
        'stereo_images_path': '../calibration-images/calibration-images/stereo_images/', 
...
def calibration_yaml_fixture(tmp_path_factory):
    ...
    yaml_file = tmp_path_factory.mktemp("test_data") / "test_calibrator_config.yaml"
